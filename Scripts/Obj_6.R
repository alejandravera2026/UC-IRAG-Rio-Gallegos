#==============================================================================
# PROPORCIÓN SEMANAL DE INTERNACIONES POR IRAG E IRAG EXTENDIDA
# GRÁFICO DE LÍNEAS + PUNTOS
#==============================================================================
...
curva_internaciones_irag <- highchart() %>%
  ...
  hc_subtitle(
    text = "Proporción semanal sobre el total de internaciones. Unidad Centinela HRRG, 2024–2026"
  ) %>%
